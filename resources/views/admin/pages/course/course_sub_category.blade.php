...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    ...
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Sub Category</h4>
                        ...
                        <div class="flex-wrap breadcrumb-action justify-content-center">
                            {{-- <a href="javascript:editModal('{{ route('sub-category-add', ['language' => app()->getLocale()]) }}','category-form-modal','form-modal','Add Sub Category')"
                                class="btn btn-sm btn-primary me-0 radius-md"> --}}
                                <a href="javascript:editModal('{{ route('sub-category-add', ['language' => app()->getLocale()]) }}','category-form-modal','form-modal','Add Category')"
                                    class="btn btn-sm btn-primary me-0 radius-md">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="flex-wrap mb-0 orderDatatable_actions d-flex float-end">
                                                    ...
                                                    <li>
                                                        <a href="javascript:editModal('{{ route('sub-category-edit', $subcategory->id , ['language' => app()->getLocale() ]) }}','category-form-modal','form-modal')"
                                                            class="edit">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{route('sub-category-delete' , $subcategory->id)}}" method="post" id="delete-category-form-1">
                                                            @csrf
                                                            {{-- @method('delete') --}}
                                                        </form>
                                                    </li>
    ...
    {{-- <section class="w-100">
        <h1 class="text-center py-3 m-0 text-dark w-100" >Manage Products</h1>
        ...
        <table class="table table-striped text-center border-2 text-bold">
            ...
            <tr>
                ...
                <td>{{$product->total_course}}</td>
                <td>{{$product->status}}</td>
                <td class="float-left">
                    <a href="{{route('product.edit', $product->id)}}" type="button" class="btn btn-success m-2"><i class="bi bi-pencil-square"></i></a>
                    <a href="{{route('product.delete', $product->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are You Sure?')"><i class="bi bi-trash"></i></a>
                </td>
            </tr>
