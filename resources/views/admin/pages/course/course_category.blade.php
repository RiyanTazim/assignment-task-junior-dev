...
@section('content')
                ...
                <div class="shop-breadcrumb">
                    ...
                    <div class="breadcrumb-main">
                        ...
                        <div class="flex-wrap breadcrumb-action justify-content-center">
                            <a href="javascript:editModal('{{ route('category-add', ['language' => app()->getLocale()]) }}','category-form-modal','form-modal','Add Category')"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="mb-0 orderDatatable_actions d-flex float-end">
                                                    ...
                                                    <li>
                                                        <a href="javascript:editModal('{{ route('category-edit', $category->id, ['language' => app()->getLocale()]) }}','category-form-modal','form-modal')"
                                                            class="edit">
                                                    ...
                                                    <li>
                                                        {{-- <a href="javascript:deleteData('delete-category-form-1','Are you sure?','You want to delete this category?')" class="remove"
                                                            ...
                                                            <form action="{{route('category-delete', $category->id)}}"  id="delete-category-form-1">
                                                                @csrf
                                                                @method('delete')
                                                            </form>
                                                        </a> --}}
                                                        {{-- <a href="javascript:deleteData('delete-category-form-1','Are you sure?','You want to delete this category?')"
                                                            class="remove">
                                                            <svg width="17" height="17" viewBox="0 0 17 17"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                        ...
                                                        <form action="{{route('category-delete')}}"  id="delete-category-form-1">
                                                            @csrf
                                                        ...
                                                        <form action="{{route('category-delete' , $category->id)}}" method="post" id="delete-category-form-1">
                                                            @csrf
                                                            {{-- @method('delete') --}}
                                                        </form>
    ...
    {{-- <section class="w-100">
        <h1 class="text-center py-3 m-0 text-dark w-100" >Manage Category</h1>
        ...
        <table class="table table-striped text-center border-2 text-bold">
            <thead class=" text-dark" style="background-color: #EDF5E1">
                <th>Id</th>
                <th>Category Name</th>
            ...
            <tr>
                ...
                <td>{{$category->total_sub_category}}</td>
                <td>{{$category->total_course}}</td>
                <td>{{$category->is_featured}}</td>
                <td>{{$category->status}}</td>
                <td class="float-left">
                    <a href="{{route('category.edit', $category->id)}}" type="button" class="btn btn-success m-2"><i class="bi bi-pencil-square"></i></a>
                    <a href="{{route('category.delete', $product->id)}}" type="button" class="btn btn-danger" onclick="return confirm('Are You Sure?')"><i class="bi bi-trash"></i></a>
                </td>
            </tr>
